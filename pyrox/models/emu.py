...
class EmulationGenerator(meta.PyroxObject, metaclass=factory.FactoryTypeMeta[Self, EmulationGeneratorFactory]):
    ...
    def _generate_base_module_emulation(self) -> None:
        ...
        for controller_type in plc.ModuleControlsType:
    ...
    def add_rung_to_safety_routine(self, rung: plc.Rung) -> None:
    ...
    def add_rung_to_standard_routine(self, rung: plc.Rung) -> None:
