...
from .plc import controller, imodule, ModuleControlsType
...
class EmulationGenerator(meta.PyroxObject, metaclass=factory.FactoryTypeMeta[Self, EmulationGeneratorFactory]):
    ...
    def __init__(
        ...
        super().__init__()
        self.generator_object: controller.Controller = controller
    ...
    def _generate_base_module_emulation(self) -> None:
        ...
        for controller_type in controller.ModuleControlsType:
    ...
    def _generate_builtin_common(
        ...
        modules: list[controller.IntrospectiveModule] = imodule.ModuleWarehouseFactory.filter_modules_by_type(
