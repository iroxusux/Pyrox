...
from pyrox.models.gui.meta import PyroxFrame, PyroxDefaultTheme
...
class PyroxCommandBar(PyroxFrame):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.separator_color = separator_color or PyroxDefaultTheme.bordercolor
    ...
    def add_button(self, button_config: CommandButton) -> None:
        ...
        button = tk.Button(
            ...
            activebackground=PyroxDefaultTheme.button_hover,
            activeforeground=PyroxDefaultTheme.foreground_selected
        )
    ...
    def _setup_hover_effects(self, button: tk.Button) -> None:
        ...
        def on_enter(event):
            button.config(
                background=PyroxDefaultTheme.button_hover,
                relief='solid'
            )
