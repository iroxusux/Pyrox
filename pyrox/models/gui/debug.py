...
class LadderCanvas(Canvas, Loggable):
    ...
    def _draw_rung(self, rung: controller.Rung, rung_number: int, y_pos: int):
    ...
    def _draw_rung_sequence(self, rung: controller.Rung, rung_number: int, y_pos: int, start_x: int):
    ...
    def _draw_rung_instructions(self,
                                instructions: List[controller.LogixInstruction],
    ...
    def _draw_instruction(self, instruction: controller.LogixInstruction, x: int, y: int,
    ...
    def _draw_contact(self, instruction: controller.LogixInstruction, x: int, center_y: int,
    ...
    def _draw_coil(self, instruction: controller.LogixInstruction, x: int, center_y: int,
                   rung_number: int) -> LadderElement:
    ...
    def _draw_block(self, instruction: controller.LogixInstruction, x: int, center_y: int,
                    rung_number: int) -> LadderElement:
    ...
    def _update_rung_structure_with_branch(self, rung_number: int, branch: LadderBranch):
        ...
        instructions = re.findall(controller.INST_RE_PATTERN, current_text)
    ...
    def _insert_contact(self, x: int, center_y: int, rung_number: int, branch_level: int = 0):
        ...
        new_instruction = controller.LogixInstruction(
    ...
    def _add_instruction_to_rung(self, instruction: controller.LogixInstruction, rung_number: int):
...
class DebugTaskFrame(TaskFrame):
    """Pyrox Debugging Task Frame.
    For developmental use only."""

    TOOLBAR_PACK_SIDE = 'left'
    TOOLBAR_PADDING_X = 2

    def __init__(self,
                 master):
        super().__init__(master,
                         name='Pyrox Debugger Task Frame')
        self._setup_ui()
    ...
    def _create_toolbar(self):
        ...
        tk.Button(toolbar, text="Select",
                  command=lambda: self._set_mode(LadderEditorMode.VIEW)).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                                              padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        tk.Button(toolbar, text="Contact",
                  command=lambda: self._set_mode(LadderEditorMode.INSERT_CONTACT)).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                                                        padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        tk.Button(toolbar, text="Coil",
                  command=lambda: self._set_mode(LadderEditorMode.INSERT_COIL)).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                                                     padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        tk.Button(toolbar, text="Block",
                  command=lambda: self._set_mode(LadderEditorMode.INSERT_BLOCK)).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                                                      padx=DebugTaskFrame.TOOLBAR_PADDING_X)

        # Branch controls
        tk.Button(toolbar, text="Branch",
                  command=lambda: self._set_mode(LadderEditorMode.INSERT_BRANCH)).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                                                       padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        ...
        tk.Button(toolbar, text="Add Rung",
                  command=self._add_rung).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                               padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        tk.Button(toolbar, text="Delete Rung",
                  command=self._delete_current_rung).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                          padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        ...
        tk.Button(toolbar, text="Verify",
                  command=self._verify_routine).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                     padx=DebugTaskFrame.TOOLBAR_PADDING_X)
        tk.Button(toolbar, text="Accept",
                  command=self._accept_changes).pack(side=DebugTaskFrame.TOOLBAR_PACK_SIDE,
                                                     padx=DebugTaskFrame.TOOLBAR_PADDING_X)
