...
class PyroxTreeView(ttk.Treeview):
    ...
    def subscribe_to_selection(
        ...
        Args:
            callback: A function to call back on selection change. It can take keyword arguments:
                tree_item_id: str - The ID of the selected tree item
                selected_object: Any - The object associated with the selected item
                is_right_click: bool - Whether the selection was via right-click
                context_menu: Optional[PyroxContextMenu] - The context menu if right-click
                event: Optional[tk.Event] - The original Tkinter event
        """
