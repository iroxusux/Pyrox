...
class TestUtils(unittest.TestCase):
    ...
    def test_bit_operations(self):
        ...
        my_other_val = utils.set_bit(my_other_val, 0)
        self.assertEqual(my_other_val, 1)
        my_other_val = utils.set_bit(my_other_val, 1)
        self.assertEqual(my_other_val, 3)
        my_other_val = utils.clear_bit(my_other_val, 0)
        self.assertEqual(my_other_val, 2)
