...
class ViewTask(ApplicationTask):
    ...
    def inject(self) -> None:
        ...
        if not self.application.all_directories:
        ...
        for dir_name in self.application.all_directories:
            drop_down.add_command(label=dir_name, command=lambda d=dir_name: self._open_dir(self.application.all_directories[d]))
