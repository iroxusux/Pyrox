...
class SupportsClass(SupportsMeta[str]):
    ...
    @property
    def plc_class(self) -> str:
        return super().__get__()

    @plc_class.setter
    def plc_class(self, value: str):
        super().__set__(value)
...
class Module(PlcObject):
    ...
    def communications(self) -> list[dict]:
        ...
        if not isinstance(self['Communications']['Communication'], list):
            return [self['Communications']['Communication']]
...
class Program(SupportsClass):
    def __init__(self,
        ...
        super().__init__(l5x_meta_data=l5x_meta_data,
                         controller=controller)
        self._routines = [self.config.routine_type(x, self, self._controller) for x in self.raw_routines]
...
class Routine(PlcObject):
    def __init__(self,
        ...
        self._rungs = [self.config.rung_type(x, self.controller) for x in self.raw_rungs]
...
class Controller(PlcObject, Loggable):
    ...
    def raw_aois(self) -> list[dict]:
        ...
        """
        return self.l5x_meta_data['AddOnInstructionDefinitions']['AddOnInstructionDefinition']
    ...
    def comm_path(self) -> str:
        ...
        """
        return self.l5x_meta_data['@CommPath']
    ...
    def raw_datatypes(self) -> list[dict]:
        ...
        """
        return self.l5x_meta_data['DataTypes']['DataType']
    ...
    def major_revision(self) -> int:
        ...
        """
        return int(self.l5x_meta_data['@MajorRev'])
    ...
    def minor_revision(self) -> int:
        ...
        """
        return int(self.l5x_meta_data['@MinorRev'])
    ...
    def raw_modules(self) -> list[dict]:
        ...
        """
        return self.l5x_meta_data['Modules']['Module']
    ...
    def name(self) -> str:
        ...
        """
        return self.l5x_meta_data['@Name']
    ...
    def plc_module_icp_port(self) -> dict:
        ...
        """
        return next((x for x in self.plc_module_ports if x['@Type'] == 'ICP'), None)
    ...
    def raw_programs(self) -> list[dict]:
        ...
        """
        return self.l5x_meta_data['Programs']['Program']
    ...
    def raw_tags(self) -> list[dict]:
        ...
        """
        return self.l5x_meta_data['Tags']['Tag']
