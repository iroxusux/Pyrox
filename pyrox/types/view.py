...
from .abc.meta import PartialView, PartialViewType, PartialViewConfiguration
...
class View(PartialView):
    ...
    def __init__(self,
        ...
        super().__init__(config=PartialViewConfiguration(parent=parent,
                                                         view_type=PartialViewType.EMBED))
